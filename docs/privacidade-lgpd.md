...
Tribunal TJSP: Consulta Processual Unificada (Eproc) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [tribunal_tjsp_eproc_unificada@mcp.ai](mailto:tribunal_tjsp_eproc_unificada@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
